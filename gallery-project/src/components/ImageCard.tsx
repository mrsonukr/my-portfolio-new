...
export const ImageCard: React.FC<ImageCardProps> = ({ photo, onClick }) => {
  ...
  return (
    <div
      className="relative group cursor-pointer overflow-hidden rounded-2xl bg-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 ease-out transform hover:scale-[1.02]"
      onClick={onClick}
    >
      {!isLoaded && !isError && (
        <div 
