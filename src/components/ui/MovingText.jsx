...
const MovingText = () => {
  return (
    <div className="flex items-center font-semibold text-2xl h-10 rounded-lg text-white">
      <h2>I Build More</h2>
      <div className="relative overflow-hidden h-10 ml-2">
        ...
        {words.map((word, index) => (
          <span
            key={index}
            className="word block h-full leading-10 pl-1.5 text-primary hue-rotate-[120deg] animate-spin_4991"
          >
            {word}
          </span>
        ))}
