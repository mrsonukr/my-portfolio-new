    ...
    <>
      <style>{`
        ...
        .white-button:hover .label {
          color: #00ff00 !important; /* primary green on hover */
        }
      `}</style>
      ...
      <a
        ref={buttonRef}
        href="#"
        className="white-button relative inline-flex items-center justify-center px-6 py-3 rounded-full font-semibold text-base overflow-hidden transition-colors duration-200 group"
      >
        <span
          ref={flairRef}
