          ...
          <form ref={formRef} className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                name="name"
                required
                className="w-full px-4 py-2 rounded-lg border border-gray-600 bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <div className="text-center">
              {isSubmitting ? (
                <button
                  type="submit"
                  disabled
                  className="bg-gray-400 text-gray-700 cursor-not-allowed px-6 py-3 rounded-full font-semibold text-base"
                >
                  Sending...
                </button>
              ) : (
