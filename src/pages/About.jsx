...
const About = () => {
  ...
  const education = [
    ...
    {
      institution: "+2 High School Chilahri",
      location: "Buxar",
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div ref={heroRef} className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            I'm a passionate full-stack developer specializing in creating innovative web solutions. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div ref={educationRef} className="space-y-6">
              {education.map((edu, index) => (
                <div key={index} className="flex gap-4 items-start education-item">
                  <div className="mt-1">
                    <FaGraduationCap className="w-6 h-6 text-primary" />
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold dark:text-white">{edu.institution}</h3>
            ...
            <div ref={imageRef} className="relative flex items-center justify-center h-full md:-mt-8">
              <img
        ...
        <section ref={skillsRef} className="mb-16">
          <h2 className="text-3xl font-bold mb-8 dark:text-white">Skills & Expertise</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex items-center gap-4 contact-item">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">mssonukr@gmail.com</p>
              </div>
            </div>
            <div className="flex items-center gap-4 contact-item">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Ambala, Haryana - 133207</p>
              </div>
            </div>
            <div className="flex items-center gap-4 contact-item">
